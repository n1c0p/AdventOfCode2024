...
public class DayOneService : IDayOneService
{
    ...
    private static readonly List<int> _secondIdsLocationList = new()
    {
        98209,
        63343,
        84541,
    ...
    public async Task<int> PartOneAsync()
    {
        ...
        var firstIdsLocationListOrderByIdLocation = _firstIdsLocationList.OrderBy(x => x).ToList();
        var secondIdsLocationListOrderByIdLocation = _secondIdsLocationList.OrderBy(x => x).ToList();
